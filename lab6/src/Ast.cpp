...
void FunctionDef::genCode()
{
    ...
    // set the insert poidAddint to the entry basicblock of this function.
    ...
    if(funcPDef != nullptr){
        ...
        while(defPtr != nullptr){
            ...
            entry->insertFront(new AllocaInstruction(alloc_dst_addr, alloc_se));
...
void Id::genCode()
{
    ...
    if(!idType->isArray()){
        ...
        if (arrayIndex!=nullptr) {
            ...
            while (true) {
                // std::cout<<"lower:"<<lowerType->toStr()<<std::endl;
                // std::cout<<"higher:"<<currentType->toStr()<<std::endl;
