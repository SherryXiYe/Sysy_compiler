...
public:
    enum { IMM, VREG, REG, LABEL, SREG/*浮点寄存器*/};
    MachineOperand(int tp, double val);
    ...
    bool isSReg() {return this->type == SREG; };//add by zsr 2022年12月23日16:26:43
...
public:
    LoadMInstruction(MachineBlock* p,
                    ...
                    int cond = MachineInstruction::NONE);
    LoadMInstruction(MachineBlock* p,
                    MachineOperand* dst, SymbolEntry* se, int cond = MachineInstruction::NONE);
    void output();
...
public:
    StoreMInstruction(MachineBlock* p,
                    ...
                    int cond = MachineInstruction::NONE);
    StoreMInstruction(MachineBlock* p,
                    MachineOperand* src1, SymbolEntry* se, bool isParam, int cond = MachineInstruction::NONE);
    void output();
